...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text="<b>ʜᴇʏ ᴅᴜᴅᴇ 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ᴏɴ ᴏᴜʀ <a href='https://t.me/RSK_MOVIEz'>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ​👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ​ ", url=f"t.me/RSK_MOVIEz")]]))
    ...
    if query.data.startswith("file"):
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  InlineKeyboardButton("❤️‍🔥 ᴍᴏᴠɪᴇs​ ❤️‍🔥", url='https://t.me/RSK_MOVIEz')
                 ]
                ]
            )
        )
        ...
        buttons = [[
            ...
            InlineKeyboardButton('✧ ᴄᴏɴᴛᴀᴄᴛ​', url='t.me/Susil25sk')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="● ◌ ◌"
        ...
        buttons = [[
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ sᴜᴘᴘᴏʀᴛ', url='https://t.me/RSK_Admin_bot')
        ],[
            InlineKeyboardButton('⇍ ʙᴀᴄᴋ', callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton('Pʀᴇᴍɪᴜᴍ Fᴇᴀᴛᴜʀᴇꜱ 💸', callback_data='help1')  
        ], [
            ...
            InlineKeyboardButton('Sᴇᴛᴛɪɴɢs ⚙️', callback_data='setting_btn')
        ], [
        ...
        if query.from_user.id in ADMINS:
            ...
            await query.answer("⚠ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ⚠\n\nɪᴛꜱ ᴏɴʟʏ ғᴏʀ ᴍʏ ᴀᴅᴍɪɴ", show_alert=True)
